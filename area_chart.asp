...
$('#containerShare').highcharts({
    ...
    title: {
        text: 'Actuals Production - area chart'
    },
    tooltip: {
                pointFormat: '<span style="color:{series.color}">{series.name}</span>: <b>{point.percentage:.1f}%</b> ({point.y:,.0f} dp)<br/>',
                shared: true
            },
...
<body>
    <header>
        ...
        <a href="stacked_chart.asp">Stacked chart</a>
    </header>
